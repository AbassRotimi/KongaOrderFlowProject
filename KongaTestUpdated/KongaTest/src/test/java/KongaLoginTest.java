...
public class KongaLoginTest {
    ...
    @Test (priority = 3)
        public void iFrame() throws InterruptedException {
            //22. Locate the iFrame modal
            driver.findElement(By.tagName("iframe"));
            //23. Switch focus to iFrame
            driver.switchTo().frame("preview-notification-frame");

            //24. Close the iFrame that displays Subcribtion email
            WebElement CloseiFrame = driver.findElement(By.id("NC_CLOSE_ICON"));
            CloseiFrame.click();
            Thread.sleep(4000);
